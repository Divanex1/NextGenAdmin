...
const VendorComplaint = () => {
    ...
    const fetchVendorComplaints = async () => {
        try {
            const res = await getData('/complaint/vendor-complaint/list');
            setCompList(res.data)
        } catch (error) {
            console.log("error Fetch complaints", error)
        }
    }
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="breadcrumb-main">
                            <h4 className="text-capitalize breadcrumb-title">Vendor Complaint List</h4>
                            <div className="breadcrumb-action justify-content-center flex-wrap">
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb">
                                        <li className="breadcrumb-item"><Link to="/"><i className="uil uil-estate"></i>Dashboard</Link></li>
                                        <li className="breadcrumb-item active" aria-current="page">Vendor Complaint List</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
